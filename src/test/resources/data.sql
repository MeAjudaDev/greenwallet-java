...
INSERT INTO transactions (user_id, category_id, description, value, is_fixed, due_date, type, state) VALUES (1, 1, 'Curso de Java na Udemy', 27.00, false, '2021-07-08', 'E', 'A');
INSERT INTO transactions (user_id, category_id, description, value, is_fixed, due_date, type, state) VALUES (2, 2, 'Ganhos da empresa', 100.00, true, '2021-07-08', 'R', 'A');